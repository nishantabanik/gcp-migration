...
resource "google_container_cluster" "cluster" {
  ...
  secret_manager_config {
    enabled = var.secret_manager_config
  }
  ...
  dynamic "master_authorized_networks_config" {
    for_each = var.vpc_config.master_authorized_ranges != null || var.vpc_config.gcp_public_cidrs_access_enabled != null ? [""] : []
    content {
      gcp_public_cidrs_access_enabled = var.vpc_config.gcp_public_cidrs_access_enabled
      dynamic "cidr_blocks" {
        for_each = var.vpc_config.master_authorized_ranges != null ? var.vpc_config.master_authorized_ranges : {}
        iterator = range
        content {
