...
resource "google_compute_subnetwork" "subnetwork" {
  ...
  */
  # PSI: Fix Unsupported argument "secondary_ip_range"
  # https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_subnetwork#secondary_ip_range
