...
[![Open in Dev Container](https://img.shields.io/static/v1?label=Dev%20Containers&message=Open%20in%20Dev%20Container&color=green)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=git@gitlab.com:psi-software-se/terraform/gcp-2-networking.git)
...
* The hub/landing Cloud DNS hosts configurations for
  * on-prem forwarding,
  * Google API domains,
  * DNS peering for the environment-specific domains (e.g. prod.gcp.example.com),
  * and the top-level private zone/s (e.g. gcp.example.com).

* The spokes Cloud DNS host configurations for the
  * environment-specific domains and private zones (e.g. prod.gcp.example.com),
  * a peering zone for the `.` (root) zone is then created on each spoke, delegating all DNS resolution to hub/landing.
...
<p align="center">
  <img src="peering-no-cross-project-binding.svg" alt="A Shared VPC setup with DNS peering">
</p>
...
Google Cloud: `10.95.0.0/16`

The following subnets are configured:

| CIDR           | Region                       | Description                      |
|----------------|------------------------------|----------------------------------|
| `10.95.0.0/24` | Frankfurt (`europe-west3`)   | Default subnet for landing       |
| `10.95.1.0/24` | Netherlands (`europe-west4`) | Default subnet for dev           |
| `10.95.2.0/24` | Frankfurt (`europe-west3`)   | Default subnet for dev           |
| `10.95.3.0/24` | Netherlands (`europe-west4`) | Default subnet for prd           |
| `10.95.4.0/24` | Frankfurt (`europe-west3`)   | Default subnet for prd           |
| `10.95.5.0/24` | Frankfurt (`europe-west3`)   | Default subnet for dev GKE nodes |

Configuration takes place in the `data/subnets` folder.
...
Private Google Cloud DNS: `10.95.0.2`
...
|---|---|---|---|
| [dns-c2p.tf](./dns-c2p.tf) | Development spoke DNS zones and peerings setup. | <code>dns</code> |  |
| [dns-landing.tf](./dns-landing.tf) | Landing DNS zones and peerings setup. | <code>dns</code> · <code>dns-response-policy</code> |  |
| [dns-legacy.tf](./dns-legacy.tf) | Development spoke DNS zones and peerings setup. | <code>dns</code> |  |
...
| [providers_2-networking-providers.tf](./providers_2-networking-providers.tf) | None |  |  |
| [regions.tf](./regions.tf) | Compute short names for regions. |  |  |
| [spoke-c2p.tf](./spoke-c2p.tf) | c2p spoke VPC and related resources. | <code>net-cloudnat</code> · <code>net-vpc</code> · <code>net-vpc-firewall</code> · <code>project</code> | <code>google_project_iam_binding</code> |
| [spoke-dev.tf](./spoke-dev.tf) | Dev spoke VPC and related resources (DELETE ME). | <code>project</code> |  |
| [spoke-legacy.tf](./spoke-legacy.tf) | Legacy spoke VPC and related resources. | <code>net-cloudnat</code> · <code>net-vpc</code> · <code>net-vpc-firewall</code> · <code>project</code> | <code>google_project_iam_binding</code> |
| [spoke-prod.tf](./spoke-prod.tf) | Production spoke VPC and related resources (DELETE ME). | <code>project</code> |  |
| [variables-peerings.tf](./variables-peerings.tf) | Peering related variables. |  |  |
| [variables.tf](./variables.tf) | Module variables. |  |  |
| [versions.tf](./versions.tf) | Version pins. |  |  |
| [vpn-c2p-landing.tf](./vpn-c2p-landing.tf) | VPN between landing and c2p. | <code>net-vpn-ha</code> |  |
| [vpn-onprem.tf](./vpn-onprem.tf) | VPN between landing and onprem. | <code>net-vpn-ha</code> · <code>net-vpn-static</code> |  |

## Variables

| name | description | type | required | default | producer |
|---|---|:---:|:---:|:---:|:---:|
| [automation](variables.tf#L18) | Automation resources created by the bootstrap stage. | <code title="object&#40;&#123;&#10;  outputs_bucket &#61; string&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> | ✓ |  | <code>0-bootstrap</code> |
| [billing_account](variables.tf#L26) | Billing account id. If billing account is not part of the same org set `is_org_level` to false. | <code title="object&#40;&#123;&#10;  id           &#61; string&#10;  is_org_level &#61; optional&#40;bool, true&#41;&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> | ✓ |  | <code>0-bootstrap</code> |
...
| [dns_zone_domains](variables.tf#L57) | DNS zone domains. | <code title="object&#40;&#123;&#10;  landing &#61; string&#10;  legacy  &#61; string&#10;  c2p     &#61; string&#10;  onprem  &#61; string&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code title="&#123;&#10;  landing &#61; &#34;gcp.example.com.&#34;&#10;  legacy  &#61; &#34;legacy.gcp.example.com.&#34;&#10;  c2p     &#61; &#34;c2p.gcp.example.com.&#34;&#10;  onprem  &#61; &#34;onprem.example.com.&#34;&#10;&#125;">&#123;&#8230;&#125;</code> |  |
| [dns_zone_names](variables.tf#L74) | DNS zone names. | <code title="object&#40;&#123;&#10;  landing &#61; string&#10;  legacy  &#61; string&#10;  c2p     &#61; string&#10;  onprem  &#61; string&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code title="&#123;&#10;  landing &#61; &#34;gcp-example-com&#34;&#10;  legacy  &#61; &#34;legacy-gcp-example-com&#34;&#10;  c2p     &#61; &#34;c2p-gcp-example-com&#34;&#10;  onprem  &#61; &#34;onprem-example-com&#34;&#10;&#125;">&#123;&#8230;&#125;</code> |  |
...
| [vpn_onprem_static_primary_config](variables.tf#L244) | Static VPN gateway configuration for onprem interconnection in the primary region. | <code title="object&#40;&#123;&#10;  gateway_address_create &#61; optional&#40;bool, true&#41;&#10;  remote_ranges          &#61; list&#40;string&#41;&#10;  tunnels &#61; optional&#40;map&#40;object&#40;&#123;&#10;    peer_ip           &#61; string&#10;    shared_secret     &#61; optional&#40;string&#41;&#10;    traffic_selectors &#61; optional&#40;any, &#123; local &#61; &#91;&#34;0.0.0.0&#47;0&#34;&#93;, remote &#61; &#91;&#34;0.0.0.0&#47;0&#34;&#93; &#125;&#41;&#10;  &#125;&#41;&#41;&#41;&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>null</code> |  |

## Outputs

| name | description | sensitive | consumers |
|---|---|:---:|---|
| [cloud_dns_inbound_policy](outputs.tf#L78) | IP Addresses for Cloud DNS inbound policy. |  |  |
| [host_project_ids](outputs.tf#L83) | Network project ids. |  |  |
| [host_project_numbers](outputs.tf#L88) | Network project numbers. |  |  |
| [shared_vpc_self_links](outputs.tf#L93) | Shared VPC host projects. |  |  |
| [tfvars](outputs.tf#L98) | Terraform variables file for the following stages. | ✓ |  |
| [vpn_gateway_endpoints](outputs.tf#L104) | External IP Addresses for the GCP VPN gateways. |  |  |
| [vpn_static_gateway_endpoints](outputs.tf#L114) | External IP Addresses for the GCP Static VPN gateways. |  |  |
