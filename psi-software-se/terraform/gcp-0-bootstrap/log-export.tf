...
module "log-export-dataset" {
  source        = "git@gitlab.com:psi-software-se/terraform/modules.git//bigquery-dataset?ref=stable"
...
module "log-export-logbucket" {
  source      = "git@gitlab.com:psi-software-se/terraform/modules.git//logging-bucket?ref=stable"
...
module "log-export-pubsub" {
  source     = "git@gitlab.com:psi-software-se/terraform/modules.git//pubsub?ref=stable"
