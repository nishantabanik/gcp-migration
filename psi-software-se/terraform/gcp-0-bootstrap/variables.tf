...
# Slalom: Google Cloud Source Repositories isn't available to new customers.
...
variable "deprecated_sourcerepo" {
  description = "Use deprecated Google Cloud Source Repository for storage of Terraform modules (CI/CD)."
  type        = bool
  default     = false
}
...
variable "groups" {
  ...
  default = {
    ...
    gcp-billing-managers    = "gcp-billing-managers"
    gcp-billing-viewers     = "gcp-billing-viewers"
...
# Slalom: Separate Cloud Source repo for our Terraform modules
variable "modules_repository" {
  description = "Optional Google Cloud Source repository for modules."
  type = object({
    name = string
    type = string
  })
...
variable "outputs_location" {
  description = "tfvars and CI/CD workflow files to local filesystem."
  type        = string
  default     = null
}
